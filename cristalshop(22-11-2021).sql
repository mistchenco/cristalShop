...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2021 a las 15:06:46
...
INSERT INTO `compraestado` (`idCompraEstado`, `idCompra`, `idCompraEstadoTipo`, `compraEstadoFechaInicial`, `compraEstadoFechaFinal`) VALUES
(1, 4, 1, '2021-11-21 18:37:47', '0000-00-00 00:00:00');
...
INSERT INTO `compraitem` (`idCompraItem`, `idProducto`, `idCompra`, `compraItemCantidad`) VALUES
(1, 32, 4, 1);
...
(32, 'Piedrita', 'piedra chiquita', 2, 150),
...
--
ALTER TABLE `compra`
  MODIFY `idCompra` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `compraitem`
  MODIFY `idCompraItem` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
